%% Coarse Regression Forest Training Script
...
for g = 1:32
    ...
    for t = 3:size(files,1)
        ...
        % Training at coarse resolution, so image is downsampled by 4.
        ...
        % Creation of integral image for faster Haar-like feature
        % computations.
        ...
        % the ground truth.
        coords1 = combvec(ijk_arr(1,g)-5:ijk_arr(1,g)+5,ijk_arr(2,g)-5:ijk_arr(2,g)+5,ijk_arr(3,g)-5:ijk_arr(3,g)+5);
        coords2 = combvec(ijk_arr(1,g)-10:2:ijk_arr(1,g)+10,ijk_arr(2,g)-10:2:ijk_arr(2,g)+10,ijk_arr(3,g)-10:2:ijk_arr(3,g)+10);
...
save(sprintf('mdl%d_coarse.mat',g),'Mdl')
clear all
end